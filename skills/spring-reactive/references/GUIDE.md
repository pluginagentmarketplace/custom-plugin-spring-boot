...
This guide provides comprehensive documentation for the **spring-reactive** skill in the custom-plugin-spring-boot plugin.
...
```bash
# Invoke the skill
claude "spring-reactive - [your task description]"

# Example
claude "spring-reactive - analyze the current implementation"
```
...
def implement_spring_reactive(input_data):
    """
    Implement spring-reactive functionality.
