...
This guide provides comprehensive documentation for the **spring-data-jpa** skill in the custom-plugin-spring-boot plugin.
...
```bash
# Invoke the skill
claude "spring-data-jpa - [your task description]"

# Example
claude "spring-data-jpa - analyze the current implementation"
```
...
def implement_spring_data_jpa(input_data):
    """
    Implement spring-data-jpa functionality.
