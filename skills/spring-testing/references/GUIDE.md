...
This guide provides comprehensive documentation for the **spring-testing** skill in the custom-plugin-spring-boot plugin.
...
```bash
# Invoke the skill
claude "spring-testing - [your task description]"

# Example
claude "spring-testing - analyze the current implementation"
```
...
def implement_spring_testing(input_data):
    """
    Implement spring-testing functionality.
