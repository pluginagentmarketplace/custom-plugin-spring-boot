# Spring Microservices Guide

## Overview

This guide provides comprehensive documentation for the **spring-microservices** skill in the custom-plugin-spring-boot plugin.
...
```bash
# Invoke the skill
claude "spring-microservices - [your task description]"

# Example
claude "spring-microservices - analyze the current implementation"
```
...
def implement_spring_microservices(input_data):
    """
    Implement spring-microservices functionality.
