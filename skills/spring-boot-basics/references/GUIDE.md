...
This guide provides comprehensive documentation for the **spring-boot-basics** skill in the custom-plugin-spring-boot plugin.
...
```bash
# Invoke the skill
claude "spring-boot-basics - [your task description]"

# Example
claude "spring-boot-basics - analyze the current implementation"
```
...
def implement_spring_boot_basics(input_data):
    """
    Implement spring-boot-basics functionality.
