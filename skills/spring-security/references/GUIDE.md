...
This guide provides comprehensive documentation for the **spring-security** skill in the custom-plugin-spring-boot plugin.
...
```bash
# Invoke the skill
claude "spring-security - [your task description]"

# Example
claude "spring-security - analyze the current implementation"
```
...
def implement_spring_security(input_data):
    """
    Implement spring-security functionality.
